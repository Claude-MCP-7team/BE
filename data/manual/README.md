...
| 20260319005400112218 | (국토부) 26년 청년월세 지원사업 | **온통청년 API 원본 레코드 그대로**(`raw/page-002.json`). 전국·소득 60%·"지자체 청년월세와 중복 불가" → 가평 월세와 `category_overlap` 상충. 소득 55% 가평 사용자에게 둘 다 적격 → **보수 조합은 하나만(480만원, 제외 사유 첨부), 최대 조합은 둘 다(540만원)** — 시나리오 5. 신청기간(5/29)이 지났는데 적격으로 나오는 건 BE 미결 #13 |
